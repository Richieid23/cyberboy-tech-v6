...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Richieid23/cyberboy-tech/refs/heads/main/Regist| grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Richieid23/cyberboy-tech/refs/heads/main/Regist| grep $MYIP | awk '{print $3}')
fi
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Owner        : AMAQ NAJWA \e[0m"
echo -e "\033[1;96m  Contact WA   : 083129559171 \e[0m"
